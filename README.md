...
- **Ambience slot** — Independent looping audio layer with its own volume slider; load via Alt+click on any Drive link, or plain click on links starting with `ambience`, `[ambience]`, or `[amb]`
